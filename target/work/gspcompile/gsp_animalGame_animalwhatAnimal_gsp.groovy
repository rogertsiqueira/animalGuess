...
class gsp_animalGame_animalwhatAnimal_gsp extends GroovyPage {
...
invokeTag('form','g',16,['name':("formAnimal"),'controller':("animal"),'action':("learn"),'update':("")],2)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1461387618000L
